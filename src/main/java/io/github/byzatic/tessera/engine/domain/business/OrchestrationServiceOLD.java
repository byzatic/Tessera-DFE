...
public class OrchestrationServiceV0 implements OrchestrationServiceInterface {
    private final static Logger logger= LoggerFactory.getLogger(OrchestrationServiceV0.class);
    private final SchedulerInterface scheduler;
    private final ServicesManagerInterface serviceManager;
    private Integer state = 0;

    public OrchestrationServiceV0(@NotNull SchedulerInterface scheduler, @NotNull ServicesManagerInterface serviceManager, @NotNull GraphManagerInterface graphManager) {
