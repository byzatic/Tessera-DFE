...
PROJECT_INITIAL_REVISION_TIMEOUT_SECONDS="${PROJECT_INITIAL_REVISION_TIMEOUT_SECONDS-}"
...
build_java_opts() {
  ...
  add_sysprop_if_set "projectInitialRevisionTimeoutSeconds" "${PROJECT_INITIAL_REVISION_TIMEOUT_SECONDS}"
